<template>
	...
	<!-- <span class="el-dropdown">
		...
		<el-button size="small" type="primary" @click="maximize">
			<el-icon><FullScreen /></el-icon>{{ $t("tabs.maximize") }}
		</el-button>
		<el-button size="small" type="primary" @click="closeCurrentTab">
			<el-icon><Remove /></el-icon>{{ $t("tabs.closeCurrent") }}
		</el-button>
		<el-button size="small" type="primary" @click="closeOtherTab">
			<el-icon><CircleClose /></el-icon>{{ $t("tabs.closeOther") }}
		</el-button>
		<el-button size="small" type="primary" @click="closeAllTab">
			<el-icon><FolderDelete /></el-icon>{{ $t("tabs.closeAll") }}
		</el-button>
	</span> -->
</template>
